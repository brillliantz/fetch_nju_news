...
import time
import sys
sys.path.append(r'E:\SYS Files\Documents\Python files\NJU_Login\WeChat')
# if we want to use enterprise account, just replace "Wechat_dyh" with "Wechat_qyh"
import Wechat_dyh
...
if __name__ == '__main__':
  ...
  #----------------the token of Enterprise account
  #we = Wechat.Wechat('wxc4b283a95e98f9fa', 
                     #'GaUwoWqrlCB63BBgBOVX5eUYxciWWHUIEf2UKPvrWZ_VP4PH9g6hfm803qMhp6qc')
  #----------------
  
  #----------------the token of Subscription account
  we = Wechat_dyh.Wechat('wxd3cf3fc488159271', '840a8b5187a8a93b6b91feb90074b501') # IcebergRobot
  #we = Wechat_dyh.Wechat('wxca28e53ccd4ff8a1','261db1b08812f1e5b327edf7fd63d3ef') # test account
  #----------------
  
  we.get_token()
  
  #for msg in msgs:
    #we.send_kefu_msg(msg)
  we.send_msg('\n\n'.join(msgs))
  time.sleep(20)
  we.check_msg_status()
  t = time.localtime()
